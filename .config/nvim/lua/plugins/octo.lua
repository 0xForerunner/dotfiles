...
return {
  ...
  dependencies = {
    ...
    { "AstroNvim/astroui", opts = { icons = { Octo = "" } } },
    {
      ...
      opts = function(_, opts)
        ...
        maps.v[prefix .. "c"] = { desc = "Comments" }
        maps.v[prefix .. "ca"] = { "<Cmd>Octo comment add<CR>", desc = "Add a new comment" }
        maps.v[prefix .. "cd"] = { "<Cmd>Octo comment delete<CR>", desc = "Delete a comment" }
        ...
        maps.n[prefix .. "pf"] = { "<Cmd>Octo pr changes<CR>", desc = "List changed files in PR" }
        ...
        maps.n[prefix .. "pl"] = { "<Cmd>Octo pr list<CR>", desc = "List open PRs" }
  ...
  opts = function(_, opts)
    ...
    opts.mappings = {}
    opts.picker = (is_available "snacks.nvim" and "snacks")
